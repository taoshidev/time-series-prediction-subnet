...
class TesLunarCrushFeatureSources(unittest.TestCase):
    ...
    def test_lunarcrush_coin_feature_source(self):
        ...
        expected_values = {
            ...
            -1: {
                ...
                FeatureID.BTC_SOCIAL_POSTS_ACTIVE: 41692,
                FeatureID.BTC_SOCIAL_CONTRIBUTORS_CREATED: 1232,
                FeatureID.BTC_SOCIAL_CONTRIBUTORS_ACTIVE: 19942,
                FeatureID.BTC_SOCIAL_INTERACTIONS: 9854324,
                FeatureID.BTC_SOCIAL_DOMINANCE: 30.656107765498277,
            },
        }
